<nav class="navbar navbar-default navbar-fixed-top"> 
  ...
  <div id="navbar">
    <ul class="nav navbar-nav">
      <li class="active menu-toggle"> <a href="#menu-toggle" id="menu-toggle"> <i class="fa fa-menu"></i> </a> </li>
    </ul>
    ...
    <ul class="nav navbar-nav navbar-right notifications">
      <li class="dropdown balance">
        <div class="control-group">
          <div class="controls"> <span style="color:#333;">Balance: <?php balance($owner);?></span>
          ...
          <div class="controls">
            <form method="post" action="lang/change-lang.php">
              <div class="lang-select">
                <select onchange="this.form.submit()" name="selected_lang" class="selectpicker" data-width="190px">
      ...
      <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        <?php avatar($userid);?>
        <span class="navbar-user"><span><?php echo ucwords($fullname);?></span></span> <b class="caret"></b> </a>
        <ul class="nav-account dropdown-menu">
          <li> <a href="profile"><i class="icon-primary fa fa-fw fa-smile"></i> <?php echo $lang['ACCOUNT_PROFILE'];?></a> </li>
          <?php 
						$lang_u = $lang['USER_MANAGEMENT'];
						$lang_a = $lang['ADMIN_SETTINGS'];
						admin_control($admin_user, $lang_u, $lang_a);
						?>
          <li> <a href="<?php echo $domain_path;?>/access/logout"><i class="icon-danger fa fa-fw fa-circle-notch"></i> <?php echo $lang['LOGOFF'];?></a> </li>
        </ul>
      </li>
